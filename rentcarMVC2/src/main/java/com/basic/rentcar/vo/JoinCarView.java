...
public class JoinCarView {
	...
	public String toString() {
		return "JoinCarView [reserveSeq=" + reserveSeq + ", no=" + no + ", name=" + name + ", price=" + price + ", img=" + img + ", qty=" + qty + ", dday=" + dday + ", rday=" + rday + ", usein=" + usein + ", usewifi=" + usewifi + ", useseat=" + useseat + ", usenavi=" + usenavi + "]";
	}
}